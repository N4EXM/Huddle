  ...
  return (
    ...
    >
        ...
        >
            <input 
                type="text"
                className='lg:p-2 lg:pl-12 lg:text-sm bg-secondBackground border-2 rounded-md w-64 outline-none md:text-xs md:p-1 md:pl-10 border-thirdBackground'
                placeholder='Search...' 
            />
            <i
            ...
            <p
                className='text-xs font-medium absolute top-2 right-2.5 px-1.5 bg-background p-1 rounded-sm text-dimText'
            >   
                Ctrl + K
            </p>
        </div>
