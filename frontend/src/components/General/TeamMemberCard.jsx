...
const TeamMemberCard = ({userId, image, name, email}) => {
  return (
    <div
        className='flex flex-row items-start justify-start bg-background rounded-md p-2 gap-2 border-2 border-thirdBackground' 
    >
        <img 
            src={image}
            alt="userImage"
